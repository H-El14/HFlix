      ...
      <div className="flex items-center justify-between py-2 px-4 md:px-16">
        <div className="flex items-center">
          ...
          <div className="md:hidden">
            <button 
              className="flex items-center text-netflix-light-gray"
              onClick={() => setShowMobileMenu(!showMobileMenu)}
            >
              Browse <ChevronDown className={`ml-1 ${showMobileMenu ? 'rotate-180' : ''} transition-transform duration-300`} size={16} />
            </button>
          </div>
        </div>
